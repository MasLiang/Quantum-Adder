...
def Carry_First_BQFA(circ, q_A, q_B, q_C, c_Carry=None, q_D=None, c_Sum=None):
    '''
    ...
    input:
        ...
        q_D         :       if the "Sum" is used in other quantum circuit, 
                                it should be duplicated to this qubit
    ...
    **Example:**
    ...
    circ = Carry_First_BQFA(circ, q[0], q[1], q[2], c_Carry=c[0], c_Sum=c[1])
    
    A Carry_First_BQFA is added to the circuit. q[0]-q[2] correspond to input 
        data A,B and input carry. The output data are stored in c[0] and c[1]
