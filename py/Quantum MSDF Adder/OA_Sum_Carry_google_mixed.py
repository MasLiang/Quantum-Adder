...
from BQFA_in_Google import *
from BQFA_in_Cuccaro import *

def OA_Sum_Carry_google_mixed(circ, q, c, n):
    '''
    This circuit is quantum online adder using both the Sum-first binary quantum full 
        adder with 4 qubits and temporary logical-and. 
...
if __name__ == "__main__":
    ...
    circ = OA_Sum_Carry_google_mixed(circ, q, c, n)
    print(circ.draw())
