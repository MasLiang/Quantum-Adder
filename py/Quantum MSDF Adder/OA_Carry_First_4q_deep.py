...
def OA_Carry_First_4q_deep(circ, q, c, n):
    '''
    This circuit is quantum online adder using the Carry-first binary quantum full 
        adder with 4 qubits. Different with OA_in_Cuccaro, this circuit utilize the 
        feature of BQFA_in_Cuccaro that qubits can be reused. So the depth of this 
        circuit is larger while less qubits are used. If user wants to add it in 
        their circuits, they need to pass their circuit, qubits, classical registers 
        and length of input data that will be used in this circuit.
    ...
    **Example:**
    ...
    circ = OA_Carry_First_4q_deep(circ, q, c, n)
